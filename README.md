...
1. [Getting started with compartmental modelling in MOOSE](Getting_started_with_compartmental_modelling_in_MOOSE.ipynb)
   Shows how to create a passive neuronal compartment in MOOSE
1. [More complex current injection protocol](More_complex_current_injection_protocol.ipynb)
   Shows how to generate various patterns of (current) pulses for injecting into a compartment
1. [Multi-compartmental neuron model](Multi-compartmental_neuron_model.ipynb)
...
1. [Synapse between two biophysical model neurons](HH_comps_with_synapse.ipynb)
